...
# Tuples
Emergency_Contact = ("Brother", "Davis", "909-449-4404")
Home_Addy = ("456 Oak Street", "Charlotte", "NC", 28202)
Instagram_Info = ("instagram", "@1am.trey", 630)
Twitter_Info = ("Twitter", "@0nly1Trev", 24)
Birth_Day = ("Birthday", 3, 1, 2007)

#Sets 
Current_Skills = {"Problem solving", "Leadership", "Time management", "Photography", "Communication"}
Skills_Learning = {"JavaScript", "Data structures", "Git", "Web design", "Python basics"}
Career_Intrest = {"Software development", "Web development", "Game development", "Data science"}
Hobbies_Stuff = {"Gaming", "Photography", "Reading", "basketball", "Music"}
...
print(Current_Course[3], "-", Course_Credit["GEEN 111"], "credits", "-", Course_Professor["GEEN 111"], "-", Course_Room["GEEN 111"] )
